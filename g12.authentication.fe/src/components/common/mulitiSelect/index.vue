  ...
  <div
    ...
    class="multiselect">
      ...
      <transition name="multiselect">
        <div
          class="multiselect__content-wrapper shadow"
          v-show="isOpen"
          @focus="activate"
          tabindex="-1"
          @mousedown.prevent
...
export default {
  ...
  props: {
    ...
    selectGroupLabel: {
      type: String,
      default: 'Nhấn enter để chọn nhóm'
    },
    /**
    ...
    deselectLabel: {
      type: String,
      default: 'Nhấn enter để bỏ chọn'
    },
    /**
     * String to show when pointing to an already selected option
     * @default 'Press enter to remove'
    ...
    deselectGroupLabel: {
      type: String,
      default: 'Nhấn enter để bỏ nhóm'
    },
    /**
...
$select-color: #79b8e0; // hover primary
$remove-color: #e68e7c;
$after-color: #b3b3b3;
